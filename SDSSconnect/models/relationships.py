...
def createRelationships(Base):
    ...
    Base.classes.Platedb_PlateRun.plates = relationship(
        ...
        order_by=Base.classes.Platedb_Plate.plate_id,
        backref='platerun')

    Base.classes.Platedb_Plate.design = relationship(
        Base.classes.Platedb_Design,
        primaryjoin=(Base.classes.Platedb_Plate.design_pk == Base.classes.Platedb_Design.pk),
        backref='plate')
    ...
    Base.classes.Platedb_Plate.pluggings = relationship(
        ...
        order_by=Base.classes.Platedb_Plugging.fscan_mjd,
        backref='plate')
    Base.classes.Platedb_Plate.currentSurveyMode = relationship(
        ...
        primaryjoin=(Base.classes.Platedb_Plate.current_survey_mode_pk ==
                     Base.classes.Platedb_SurveyMode.pk),
        backref='plates')
    ...
    Base.classes.Platedb_Tile.plates = relationship(
        Base.classes.Platedb_Plate, order_by=Base.classes.Platedb_Plate.plate_id, backref='tile')
    ...
    Base.classes.Platedb_Profilometry.measurements = relationship(
        Base.classes.Platedb_ProfilometryMeasurement,
    ...
    # MangaDB
    Base.classes.Mangadb_Exposure.set = relationship(Base.classes.Mangadb_Set, backref='exposures')
    ...
    Base.classes.Mangadb_Set.status = relationship(Base.classes.Mangadb_SetStatus, backref='sets')
    ...
    Base.classes.Mangadb_Plate.platedbPlate = relationship(
        Base.classes.Platedb_Plate, backref=backref('mangadbPlate', uselist=False))
